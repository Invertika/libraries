 ...
 */
		public int getHairStyle() { return mHairStyle; }
		void setHairStyle(int style) { mHairStyle=(byte)style; }

		/**
 * Gets the haircolor of the character.
 */
		public int getHairColor() { return mHairColor; }
		public void setHairColor(int color) { mHairColor=(byte)color; }

		/**
 * Gets the level of the character.
 */
		public int getLevel() { return mLevel; }
		public void setLevel(int level) { mLevel=(byte)level; }
		...
		public void setPosition(Point p) { mPos=p; }
	}
}
